...
async function queryFocusAssistState(option = {}){
  ...
  if(!NtQueryWnfStateData) throw new Failure("Procedure not found", { 
    code: "ERR_FFI_LOADING", 
    info: { symbol: "NtQueryWnfStateData", lib: "ntdll", api: "win32" }
  });
...
async function updateFocusAssistState(mode){
  ...
  if(!ZwUpdateWnfStateData) throw new Failure("Procedure not found", { 
    code: "ERR_FFI_LOADING", 
    info: { symbol: "ZwUpdateWnfStateData", lib: "ntdll", api: "win32" }
  });
